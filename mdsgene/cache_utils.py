...
def save_formatted_result(
    ...
    Args:
        pmid: The PMID to save results for.
        prompt: The prompt used to generate the answer.
        raw_answer: The raw answer from the AI processor.
        strategy: The strategy used to format the answer.
        formatted_result: The formatted result to save.
